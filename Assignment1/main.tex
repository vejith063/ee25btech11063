...
\item choose the correct combination of ore and location of it's deposits.\hfill{(GATE GG 2010)}
...
\item Match the optical properties  in Group I with appropriate minerals in Group Il.\hfill{(GATE GG 2010)}
...
\item Wall-rock alteration producing epidote, albite and chloride around an ore body is called \hfill{(GATE GG 2010)}
\begin{enumerate}
...
\item Match the textures/structures  in Group I with appropriate minerals in Group Il.\hfill{(GATE GG 2010)}
...
R.Oriented intergrowth \qquad \qquad \quad \quad (3) Annealing\\
S.Comb structure \qquad \qquad \qquad \qquad (4) Quenching\\
\hspace*{5.4cm}(5) Coherent exsolution
\begin{enumerate}
\begin{multicols}{2}
...
\item  Match the ore types  in Group I with path-finder elements in Group Il~(GATE GG 2010)\\
\vspace{0cm}
\textbf{Group I} 
...
Q. Earth flow \qquad \qquad \quad \quad 2. Curved tree trunks\\
...
\textbf{Group Il}\\
P. Peridote \qquad \qquad \qquad \qquad 1. Beryl\\
Q. Emerald \qquad \qquad \qquad \qquad 2. Feldspar\\
R. Amazonite \qquad \qquad \quad \qquad 3. Corundum\\
...
Q. Nyquist frequency \qquad \qquad \qquad \qquad 2. Flat spectrum\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{figs/Screenshot from 2025-08-08 12-25-34.png} 
    \caption{}
    \label{fig:48}
\end{figure}
...
\item  $5$ skilled workers can build a wall in $20$ days: $8$ semi-skilled workers can build a wall in $25$ days: $10$ unskilled workers can build a wall in $30$ days. If a team has $2$ skilled. $6$semi-skilled and $5$ unskilled workers, how long will it take to build the wall? (GATE EE 2025)
\begin{enumerate}
\begin{multicols}{4}
    \item $20$ days
    \item $18$ days
